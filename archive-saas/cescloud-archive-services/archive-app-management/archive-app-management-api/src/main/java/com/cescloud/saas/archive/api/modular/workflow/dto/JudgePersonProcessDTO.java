 ...
 */
@ApiModel("判断是否是出现人员选择")
@Data
@AllArgsConstructor
@NoArgsConstructor
@Builder
public class JudgePersonProcessDTO implements Serializable {
	...
	@NotBlank(message = "活动节点ID不能为空")
	@ApiModelProperty(value = "活动节点ID", required = true, example = "")
    ...
    @ApiModelProperty(value = "流程版本唯一标识", example = "usingProcess.adc6:10:3335306577461248")
