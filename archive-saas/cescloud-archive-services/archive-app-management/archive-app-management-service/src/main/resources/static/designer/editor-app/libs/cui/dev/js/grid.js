$.grid = $.grid||{};
 var grid = $.component( "coral.grid",{
	version: "4.0.1",
	castProperties : ["rowEditButtons", "data","subGridOptions","initData","subGridRowExpanded",  "rowList","pager","pagerTemplate", "celloptions","colModel", "picTemplate","rowattr","cellattr"],
	options: {
	...
	transTempData: function(obj) {
		...
		if (obj.editoptions && obj.editoptions.data && obj.editoptions.dataStructure !== "tree") {
			...
			for(var k =0; k< obj.editoptions.data.length;k++){
				obj.editoptions.tempData[obj.editoptions.data[k].value] = obj.editoptions.data[k];
			}
		}
		return obj;
	},
